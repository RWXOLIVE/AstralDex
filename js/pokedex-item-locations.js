...
var QUICK_MENU_TUTOR_SOURCE = [
	{locationId: 'quickmenututorsstonebadge', locationName: 'Quick Menu Tutors (Stone Badge)', requirement: 'Stone Badge', moves: ['icicle_spear', 'scale_shot', 'rock_blast', 'bullet_seed']},
	{locationId: 'quickmenututorsknucklebadge', locationName: 'Quick Menu Tutors (Knuckle Badge)', requirement: 'Knuckle Badge', moves: ['fire_punch', 'thunder_punch', 'ice_punch', 'shadow_punch', 'mega_punch', 'bullet_punch', 'poison_jab', 'brick_break']},
	{locationId: 'quickmenututorsbalancebadge', locationName: 'Quick Menu Tutors (Balance Badge)', requirement: 'Balance Badge', moves: ['take_down', 'fire_fang', 'thunder_fang', 'ice_fang', 'poison_fang', 'crunch']},
	{locationId: 'quickmenututorsdynamobadge', locationName: 'Quick Menu Tutors (Dynamo Badge)', requirement: 'Dynamo Badge', moves: ['extrasensory', 'signal_beam', 'burning_jealousy', 'scorching_sands', 'discharge', 'iron_head', 'seed_bomb']},
	{locationId: 'quickmenututorsheatbadge', locationName: 'Quick Menu Tutors (Heat Badge)', requirement: 'Heat Badge', moves: ['low_sweep', 'mud_shot', 'bulldoze', 'ice_spinner', 'lash_out']},
	{locationId: 'quickmenututorsfeatherbadge', locationName: 'Quick Menu Tutors (Feather Badge)', requirement: 'Feather Badge', moves: ['stone_edge', 'grassy_glide', 'muddy_water', 'natural_gift', 'nature_power']},
	{locationId: 'quickmenututorsmindbadge', locationName: 'Quick Menu Tutors (Mind Badge)', requirement: 'Mind Badge', moves: ['flip_turn', 'power_gem', 'hypnosis']},
	{locationId: 'quickmenututorsrainbadge', locationName: 'Quick Menu Tutors (Rain Badge)', requirement: 'Rain Badge', moves: ['aqua_tail', 'superpower', 'psycho_shift', 'bounce', 'hyper_voice']},
	{locationId: 'petalburgcity', locationName: 'Petalburg City', requirement: 'On Location', moves: ['bug_bite', 'hidden_power']},
